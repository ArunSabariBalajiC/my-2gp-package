({
  onHandleClick: function (component, event, helper) {
    ...
    metaDataAction.setCallback(this, function (metaDataResponse) {
      ...
      console.log(
        "getContact ::: userInfo >>>>>>> companyId >>>>>>>> >>>>> ",
        companyId
      );
      console.log(
        "getContact ::: userInfo >>>>>>> userId >>>>>>>> >>>>> ",
        userId
      );

      var redirectionUrl =
        "https://client5.rekzyl.com/salesforce/landing?leftServiceId=1352c6aa-d73b-4829-a709-7770bf71966a&service=salesforce&userId=" +
        userId +
        "&companyId=" +
        companyId;
