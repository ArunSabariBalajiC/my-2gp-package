({
  ...
  trigger: function (component, event, helper) {
    ...
    eUrl.setParams({
      ...
      url:
        "https://mercury.rekzyl.com/client/omessage/extension/index.html?osyncId=" +
        osyncId +
        "&integId=" +
        integId +
        "&hash=" +
        hash +
        "&orgId=https://oappstechnology-dev-ed.develop.my.salesforce.com/&leftServiceId=1352c6aa-d73b-4829-a709-7770bf71966a"
